...
@interface MineEnergyShowThreeViewCell : UITableViewCell
...
//删除
@property (weak, nonatomic) IBOutlet UIButton *del2Button;
...
//删除当前
@property (nonatomic, copy) void(^mineThrEnergyDelButtonClick)(NSInteger index);
