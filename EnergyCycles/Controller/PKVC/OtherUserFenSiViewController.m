//
//  OtherUserFenSiViewController.m
//  EnergyCycles
//
...
@interface OtherUserFenSiViewController () <UITableViewDataSource,UITableViewDelegate> {
    NSMutableArray *_dataArr;
}

@end

@implementation OtherUserFenSiViewController
...
- (void)getNetDataWithType {
    [[AppHttpManager shareInstance] getGetFriendsListWithUid1:[self.otherUserID intValue] Uid2:[User_ID intValue] Type:2 PostOrGet:@"get" success:^(NSDictionary *dict) {
