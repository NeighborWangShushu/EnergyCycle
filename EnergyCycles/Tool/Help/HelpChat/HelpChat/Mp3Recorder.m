...
//
//#pragma mark - 实现界面传值
//- (void)passFirstValueWithIndex:(NSInteger)index {
//    if ([self.delegate respondsToSelector:@selector(passFirstViewByValue:with:)]) {
...
//        [self getFirstValuewith:index];
//    }
//}
//- (void)getFirstValuewith:(NSInteger)index {
//    if ([self.delegate respondsToSelector:@selector(passFirstViewByValue:with:)]) {
//        [self.delegate passFirstViewByValue:YES with:index];
//    }
//}
//
//- (void)getRecorderValue {
//}
