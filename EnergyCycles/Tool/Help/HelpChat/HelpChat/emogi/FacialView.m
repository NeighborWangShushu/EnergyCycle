...
//        [delegate selectedFacialView:@"删除"];
        [[NSNotificationCenter defaultCenter] postNotificationName:@"selectedFacial" object:@"删除"];
    }else{
        NSString *str=[faces objectAtIndex:bt.tag];
        NSLog(@"%@",str);
//        [delegate selectedFacialView:str];
        [[NSNotificationCenter defaultCenter] postNotificationName:@"selectedFacial" object:str];
