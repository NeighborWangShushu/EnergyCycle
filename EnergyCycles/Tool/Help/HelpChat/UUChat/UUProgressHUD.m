...
- (void)show {
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        if (!edgeImageView)
            //edgeImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"pressImage_1.png"]];
...
//    [[UUProgressHUD sharedView]startAnimationWith:recorder];
//}
//- (void)startAnimationWith:(CGFloat)recorder {
//    //NSLog(@"%f",[recorder averagePowerForChannel:0]);
//    //[self updateMetersByAvgPower:[recorder averagePowerForChannel:0]];
//    [self updateMetersByAvgPower:recorder];
//}
...
//    }
//    
//    edgeImageView.image =[UIImage imageNamed:[peakImageArray objectAtIndex:imageIndex]] ;
//}
...
- (void)setState:(NSString *)str {
    ...
    //edgeImageView.image = [UIImage imageNamed:@"CancelSend.png"];
}
