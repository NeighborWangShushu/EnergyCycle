...
- (void)setPlacehoderColor:(UIColor *)placehoderColor {
    ...
    // 设置颜色
    self.placehoderLabel.textColor = [placehoderColor colorWithAlphaComponent:0.8];
}
...
- (void)layoutSubviews {
    ...
    CGSize placehoderSize = [self.placehoder boundingRectWithSize:maxSize options:NSStringDrawingTruncatesLastVisibleLine|NSStringDrawingUsesFontLeading|NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:self.placehoderLabel.font} context:nil].size;
