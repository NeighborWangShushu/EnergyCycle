...
void TwoCGContextAddRoundedRectWithHookSimple(CGContextRef c, CGRect rect, CGFloat radius) {
...
//    CGSize s = [self.infoLabel.text sizeWithFont:self.infoLabel.font];
    CGSize s = [self.infoLabel.text sizeWithAttributes:[NSDictionary dictionaryWithObjectsAndKeys:self.infoLabel.font,NSFontAttributeName, nil]];
...
- (void)drawRect:(CGRect)rect {
    ...
    TwoCGContextAddRoundedRectWithHookSimple(c, theRect, 3);
	CGContextFillPath(c);
